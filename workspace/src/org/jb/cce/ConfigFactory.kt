...
object ConfigFactory {
    ...
    private fun deserializeActionsInterpretation(map: Map<String, Any>?, builder: Config.Builder) {
        ...
        val interpretFilter = map.getAs<Map<String, Any>>("filter")
        builder.completeTokenProbability = interpretFilter.getAs("completeTokenProbability")
        builder.completeTokenSeed = interpretFilter.getAs<Double?>("completeTokenSeed")?.toLong()
